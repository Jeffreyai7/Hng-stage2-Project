...
function Aboutinfo(){
    ...
    return (
        ...
        <h1 className="exo">About our Products</h1>
        <div className="advertisedProducs-container">
            <div className="flexbox">
            <div>
                <h2 className="exo">Elevate Your Style With Our Exclusive Clothing Line</h2>
            ...
            <div className="flexbox">
            <div className="secondrack">
                <img src={secondrack} alt="clothesrack" />
            </div>
            <div>
                <h2 className="exo">Unleash Your Fashion Potential with Our Signature Clothing Line</h2>
